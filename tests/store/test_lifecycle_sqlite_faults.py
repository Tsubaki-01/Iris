...
def test_partial_session_message_insert_rolls_back_complete_model_commit(
    ...
    command = CommitModelStep(
        ...
        checkpoint=RunCheckpoint(
            ...
            sequence=2,
            activation_id="act-1",
            engine_cursor={"position": "after_model", "step_index": 1, "visible_tool_names": []},
            session_revision=1,
...
def _create_command() -> CreateRun:
    checkpoint = RunCheckpoint(
        ...
        sequence=1,
        activation_id="act-1",
        engine_cursor={"position": "before_model", "step_index": 0, "visible_tool_names": []},
        session_revision=0,
...
def _suspend_command(run_revision: int) -> SuspendRun:
    ...
    checkpoint = RunCheckpoint(
        ...
        sequence=2,
        activation_id="act-1",
        engine_cursor={"position": "after_model", "step_index": 0, "visible_tool_names": []},
        session_revision=0,
        model_steps_reserved=0,
        model_steps_committed=0,
    )
